...
public:
	...
	Matrix<Type> moveMatrix(const Type x, const Type y, const Type z);
	Matrix<Type> scaleMatrix(const Type kx, const Type ky, const Type kz);
	Matrix<Type> rotateMatrix(const Type ox, const Type oy, const Type oz);
